...
return [
     ...
     */
    'language' => env('TTS_LANGUAGE', 'es-US'),
    ...
    'services' => [
        'polly' => [
             ...
             */
            'voice_id' => env('AWS_VOICE_ID', 'Miguel'),
             ...
             */
            'credentials' => [
                'key'     => env('AWS_ACCESS_KEY_ID', 'AKIAYPNEAG5FC4566B7K'),
                'secret'  => env('AWS_SECRET_ACCESS_KEY', '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'),
            ],
